...
public class ProductEntity extends BaseEntity {
	...
	@Column(name = "mgraceperyn",  columnDefinition = "nvarchar(1) default ''" )
	private String mgraceperyn ="";
	@Column(name = "mgraceperinmnths",  columnDefinition = "numeric(4) default 0" )	
	private int mgraceperinmnths = 0;	 
	@Column(name = "mgraceperindays",  columnDefinition = "numeric(4) default 0" )	
	private int mgraceperindays = 0;	 
