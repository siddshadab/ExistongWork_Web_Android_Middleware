...
public class DailyLoanCollectionEntity extends BaseEntity {
	...
	@Column(name = "moverdueint")
	private Double moverdueint = 0d;
	@Column(name = "mpenalos")
	private Double mpenalos = 0d;
	@Column(name = "moverdueprn")
	private Double moverdueprn = 0d;
	@Column(name = "mschemiint")
	private Double mschemiint = 0d;
	@Column(name = "mschemiprn")
	private Double mschemiprn = 0d;
