...
public interface ChartsMasterRepository extends JpaRepository<ChartsMasterEntity, Long> {
	...
	@Query(value="\r\n" + 
			...
			"	charts.xcaption as xcaption ,	\r\n" +
			"	charts.ycaption as ycaption ,\r\n" +
			"	charts.isfavalwed as isfavalwed, \r\n" +
			"	charts.xcaprot as xcaprot , \r\n" +
			"	charts.ycaprot as ycaprot , \r\n" +
			"	charts.xaxisvsbl as xaxisvsbl , \r\n" +
			"	charts.yaxisvsbl as yaxisvsbl ,\r\n" +
			"	charts.islegvis as islegvis  \r\n" +
