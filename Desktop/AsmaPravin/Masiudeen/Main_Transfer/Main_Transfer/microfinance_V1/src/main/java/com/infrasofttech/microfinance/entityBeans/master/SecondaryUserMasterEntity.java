...
public class SecondaryUserMasterEntity extends BaseEntity{
	...
	private byte[] profileimage;
 	...
 	@Column(name = "mlocationtrackeronoff",  columnDefinition = "numeric(1) default 0")       	
	 private int  mlocationtrackeronoff;
 	
 	@Column(name = "mpathtrackeronoff",  columnDefinition = "numeric(1) default 0")      	
	 private int  mpathtrackeronoff;
