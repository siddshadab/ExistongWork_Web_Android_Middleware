...
@Table(name = "md009243")
@Data
public class DisbursmentListEntity extends BaseEntity {
	...
	private int mcustno = 0;
	 ...
	 @Column(name = "merrormessage",  columnDefinition = "nvarchar(32) default ''" )	  
	 private String merrormessage;
	 @Column(name = "mdisbamount" )	  
	 private double mdisbamount= 0d;
	 @Column(name = "mchargesamt0", columnDefinition = "float default 0.0" )	  
	 private double mchargesamt0= 0d;
	 @Column(name = "mchargesamt1", columnDefinition = "float default 0.0" )	  
	 private double mchargesamt1= 0d;
	 @Column(name = "mchargesamt2", columnDefinition = "float default 0.0" )  
	 private double mchargesamt2= 0d;
	 @Column(name = "mchargesamt3", columnDefinition = "float default 0.0" ) 
	 private double mchargesamt3= 0d;
	 @Column(name = "mchargesamt4", columnDefinition = "float default 0.0" )  
	 private double mchargesamt4= 0d;
	 @Column(name = "mchargesamt5", columnDefinition = "float default 0.0" )	  
	 private double mchargesamt5= 0d;
	 @Column(name = "mchargesamt6", columnDefinition = "float default 0.0" )  
	 private double mchargesamt6= 0d;
	 @Column(name = "mchargesamt7", columnDefinition = "float default 0.0" )	  
	 private double mchargesamt7= 0d;
	 @Column(name = "mchargesamt8", columnDefinition = "float default 0.0" )	  
	 private double mchargesamt8= 0d;
	 @Column(name = "mchargesamt9", columnDefinition = "float default 0.0" )	  
	 private double mchargesamt9= 0d;
	 @Column(name = "mchargescollectiontype", nullable = false, columnDefinition = "int default 0" )	
	 private int mchargescollectiontype;
	 @Column(name = "msdcollectiontype", nullable = false, columnDefinition = "int default 0" )	
	 private int msdcollectiontype;
	 @Column(name = "mthirdpartyamount", columnDefinition = "float default 0.0" )	  
	 private double mthirdpartyamount; 
