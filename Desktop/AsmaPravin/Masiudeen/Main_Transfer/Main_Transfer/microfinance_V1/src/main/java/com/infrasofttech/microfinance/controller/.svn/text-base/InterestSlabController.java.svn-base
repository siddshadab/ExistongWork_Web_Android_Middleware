...
@RestController
@RequestMapping("/InterestSlabController")
public class InterestSlabController {
	
	
	
	@Autowired 
	InterestSlabServicesImpl interestSlabServicesImpl;
...
/*	@GetMapping(value = "/get/{countryName}", produces = "application/json")
	...
	@GetMapping(value = "/getAllInterestSlab/", produces = "application/json")
	public ResponseEntity<?>  getAllInterestSlabData() {
		return interestSlabServicesImpl.getAllInterestSlabData();
	}
