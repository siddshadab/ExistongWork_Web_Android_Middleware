...
class CenterMap extends StatefulWidget {
  var muserCode;
  CenterMap(this.muserCode);

  @override
  State<StatefulWidget> createState() => _CenterMap();
}
...
class _CenterMap extends State<CenterMap> {
  ...
  void initState() {
    super.initState();
   // _ticker = Timer.periodic(Duration(seconds: 5), (Timer t) => setStateCustom());
  ...
  void onMapCreated(GoogleMapController controller) async {
    ...
    await getCenterApi(widget.muserCode).then((onValue) {
      setState(() {});
    });
  ...
  Future<Null> geCenterLiveLocation(String musrcode) async {
    markers.clear();
    markers = List<Marker>();
    showMessage("Fetching Center Locations for ${musrcode}...");
    ...
    await getCurrentLocationOnSuperUsers
      ...
      if (result != null) {
          ...
          try {
            Marker marker = Marker(
                ...
                infoWindow: InfoWindow(
                  title: "Center Id "+"("+val.musrcode.toString()+")"+" Center Name"+"("+val.musrname.toString()+")",
                  snippet: " Meeting Day "+"("+meetingDay.toString()+")"+"Next Meeting Date "+ "("+formatter.format(val.mlastupdatedt)+")",
        ...
        showMessageWithoutProgress("No Centers Found");
      }
    });
