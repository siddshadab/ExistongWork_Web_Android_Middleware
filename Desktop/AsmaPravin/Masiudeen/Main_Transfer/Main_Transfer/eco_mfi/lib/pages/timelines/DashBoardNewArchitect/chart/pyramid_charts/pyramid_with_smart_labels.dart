...
class PyramidSmartLabels extends StatefulWidget {
  PyramidSmartLabels({this.chartObject, Key key}) : super(key: key);
...
class _PyramidSmartLabelState extends State<PyramidSmartLabels> {
  ...
  Widget build(BuildContext context) {
    return  getPyramidSmartLabelChart(widget.chartObject);
  }
}

SfPyramidChart getPyramidSmartLabelChart(ChartsBean sample,
...
PyramidSeries<ChartSampleData, String> _getPyramidSeries(ChartsBean sample,
  ...
  if(sample.mtype =='xy'){
    return PyramidSeries<ChartSampleData, String>(
        ...
        textFieldMapper: (ChartSampleData data, _) => data.xValue,
...
class _PyramidSmartLabelsFrontPanelState extends State<PyramidSmartLabelsFrontPanel> {
  _PyramidSmartLabelsFrontPanelState(this.subItemList);
  final SubItem subItemList;
