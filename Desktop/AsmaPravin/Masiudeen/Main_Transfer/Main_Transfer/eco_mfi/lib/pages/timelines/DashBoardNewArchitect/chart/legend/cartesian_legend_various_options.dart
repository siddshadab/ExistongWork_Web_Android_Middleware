...
List<StackedLineSeries<ChartSampleData, String>> _getStackedLineSeries(
  ...
  final List<ChartSampleData> chartData = <ChartSampleData>[
    ChartSampleData(x: 'Food', y: 55, yValue: 40, yValue2: 45, yValue3: 48, size:28),
    ChartSampleData(
        x: 'Transport', y: 33, yValue: 45, yValue2: 54, yValue3: 28, size: 35),
    ChartSampleData(x: 'Medical', y: 43, yValue: 23, yValue2: 20, yValue3: 34, size:48),
    ChartSampleData(x: 'Clothes', y: 32, yValue: 54, yValue2: 23, yValue3: 54, size:27),
    ChartSampleData(x: 'Books', y: 56, yValue: 18, yValue2: 43, yValue3: 55, size:31),
    ChartSampleData(x: 'Others', y: 23, yValue: 54, yValue2: 33, yValue3: 56, size:35),
  ];
