...
class PyramidDefault extends StatefulWidget {
  PyramidDefault({this.subItemList, Key key}) : super(key: key);
  final SubItem subItemList;
  
  @override
  _PyramidDefaultState createState() => _PyramidDefaultState(subItemList);
}

class _PyramidDefaultState extends State<PyramidDefault> {
  _PyramidDefaultState(this.subItemList);
  final SubItem subItemList;
  
  @override
  Widget build(BuildContext context) {
     return getScopedModel(null, subItemList, DefaultPyramidFrontPanel(subItemList));
  }
}
...
class _DefaultPyramidFrontPanelState extends State<DefaultPyramidFrontPanel> {
  _DefaultPyramidFrontPanelState(this.subItemList);
  final SubItem subItemList;
