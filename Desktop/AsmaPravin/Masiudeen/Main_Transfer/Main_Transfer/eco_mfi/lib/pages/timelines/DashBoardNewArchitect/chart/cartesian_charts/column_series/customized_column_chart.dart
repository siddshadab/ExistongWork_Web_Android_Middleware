...
*/
    return getScopedModel(getCustomizedColumnChart(false,sample),sample) ;
  }
}

SfCartesianChart getCustomizedColumnChart(bool isTileView,SubItem sample) {
  return SfCartesianChart(
    ...
    series: getCustomizedColumnSeries(isTileView,sample!=null?sample.chartSampleData:null),
    tooltipBehavior:
        TooltipBehavior(enable: true, canShowMarker: false, header: ''),
  );
}

List<CustomColumnSeries<ChartSampleData, String>> getCustomizedColumnSeries(bool isTileView,List<ChartSampleData> beanValue) {
