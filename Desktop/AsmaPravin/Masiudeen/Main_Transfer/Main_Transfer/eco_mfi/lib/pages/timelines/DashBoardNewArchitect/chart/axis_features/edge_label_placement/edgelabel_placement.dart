...
class EdgeLabel extends StatefulWidget {
  EdgeLabel({this.subItemList, Key key}) : super(key: key);

  final SubItem subItemList;

  @override
  _EdgeLabelState createState() => _EdgeLabelState(subItemList);
}

class _EdgeLabelState extends State<EdgeLabel> {
  _EdgeLabelState(this.subItemList);

  final SubItem subItemList;

  @override
  Widget build(BuildContext context) {
    return getScopedModel(null, subItemList, EdgeLabelPlaceFrontPanel(subItemList));
  }
}
...
class _EdgeLabelPlaceFrontPanelState extends State<EdgeLabelPlaceFrontPanel> {
  _EdgeLabelPlaceFrontPanelState(this.subItemList);
