...
class _CollateralVehicleValuation4State
    ...
    if (selectedObj.mcodedesc.isEmpty) {
      ...
      switch (no) {
        case 0:
          ...
          CollateralVehicleMasterState.collateralVehicleBean.mbtlcolororspot =
              blankBean.mcode;
          break;
        case 1:
          BtlTanAndYan = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtltanandyan =
              blankBean.mcode;
          break;

        case 2:
          BtlCap = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtlcap =
              blankBean.mcode;
          break;
        case 3:
          BtlSplatterCap = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtlsplattercap =
              blankBean.mcode;
          break;
        case 4:
          BtrColorOrSpot = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtrcolororspot =
              blankBean.mcode;
          break;
        case 5:
          BtrTireAndYan = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtrtireandyan =
              blankBean.mcode;
          break;
        case 6:
          BtrCap = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtrcap =
              blankBean.mcode;
          break;
        case 7:
          BtrSplatterCap = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbtrsplattercap =
              blankBean.mcode;
          break;
        case 8:
          IBarSun = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mibarsun =
              blankBean.mcode;
          break;
        case 9:
          IDescriptionBook = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.midescriptionbook =
              blankBean.mcode;
          break;
        case 10:
          IAutoSystem = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.miautosystem =
              blankBean.mcode;
          break;
        case 11:
          IAirConditioner = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.miairconditioner =
              blankBean.mcode;
          break;
        case 12:
          IMirrorRemote = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mimirrorremote =
              blankBean.mcode;
          break;
        case 13:
          ISafeBell = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.misafebell =
              blankBean.mcode;
          break;
        case 14:
          IMiddleBox = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mimiddlebox =
              blankBean.mcode;
          break;
        default:
          break;
      ...
      for (int k = 0;
          k <
              globals
                  .dropdownCaptionsValuesCollateralVehicleValuation4[no].length;
          k++) {
        if (globals.dropdownCaptionsValuesCollateralVehicleValuation4[no][k]
                .mcodedesc ==
            selectedObj.mcodedesc) {
          setValue(no,
              globals.dropdownCaptionsValuesCollateralVehicleValuation4[no][k]);
          isBreak = true;
          break;
        }
        if (isBreak) {
  ...
  void initState() {
    ...
    tempDropDownValues.add(
        CollateralVehicleMasterState.collateralVehicleBean.mbtrcolororspot);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbtrtireandyan);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbtrcap);
    tempDropDownValues.add(
        CollateralVehicleMasterState.collateralVehicleBean.mbtrsplattercap);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mibarsun);
    tempDropDownValues.add(
        CollateralVehicleMasterState.collateralVehicleBean.midescriptionbook);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.miautosystem);
    tempDropDownValues.add(
        CollateralVehicleMasterState.collateralVehicleBean.miairconditioner);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mimirrorremote);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.misafebell);
    tempDropDownValues
    ...
    for (int k = 0;
      ...
      for (int i = 0;
          i <
              globals
                  .dropdownCaptionsValuesCollateralVehicleValuation4[k].length;
          i++) {
        try {
          if (globals
                  .dropdownCaptionsValuesCollateralVehicleValuation4[k][i].mcode
                  .toString()
                  .trim() ==
            ...
            setValue(
                k,
                globals.dropdownCaptionsValuesCollateralVehicleValuation4[k]
                    [i]);
          }
        } catch (_) {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: new Row(
              children: <Widget>[
                Text(
                  Translations.of(context).text('PrtOfBckTre'),
          ...
          Container(
            child: new DropdownButtonFormField(
              ...
              decoration: InputDecoration(
                  labelText: Translations.of(context).text('ClrSpt')),
            ),
          ),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('TreAndYn')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('cap')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('SplttrCp')),
          )),
          SizedBox(
            height: 10.0,
          ),
          Container(
            ...
            child: new Row(
              children: <Widget>[
                Text(
                  Translations.of(context).text('PrtOfBckTrrghtsde'),
                  style: TextStyle(color: Colors.blue, fontSize: 25.0),
                )
              ],
            ),
          ...
          Container(
            ...
            child: new Row(
              children: <Widget>[
                Text(
                  Translations.of(context).text('InsdThCr'),
                  style: TextStyle(color: Colors.blue, fontSize: 25.0),
                )
              ],
            ),
          ...
          Container(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('BrSn')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('DescBk')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('AtSys')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration:
                InputDecoration(labelText: Translations.of(context).text('AC')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('MirRmteelect')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('SfBll')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('MdlBx')),
          )),
        ],
      ),
    );
