...
class CIFListWithAuth extends StatefulWidget {
  //static const String routeName = '/material/data-table';
  final List<CIFBean> cifBean;
  final List<UserRightBean> userAccesList;
  CIFListWithAuth(this.cifBean,this.userAccesList);
...
class _CIFList
    extends State<CIFListWithAuth> {

  //bool showPersInfo = false;
  Map<int,bool> menuIdsMap = new Map<int,bool>();
  ...
  void initState() {
    ...
    for(int i= 0 ;i<widget.userAccesList.length;i++){
      menuIdsMap[widget.userAccesList[i].menuid] = true;
    }
    getSessionVariables();
  }
                ...
                children: <Widget>[
                  ...
                  new Row(
                    ...
                    children: <Widget>[
                      ...
                      (cifList[0].mcuststatus == 3 && cifList[0].mcreatedby != musrcode && menuIdsMap[51]==true) ?
                      new Align(
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, position) {
                        ...
                        if (cifList[position].mprdacctid != null &&
                          ...
                          if(cifList[0].mmoduletype==20){
                            try{
                              subAcctId = cifList[position].mprdacctid.substring(24, 32);
                            }catch(_){
                        ...
                        try {
                          ...
                          if (subAcctId != null && subAcctId != 'null') {
                            subAccountIdint = int.parse(subAcctId);
                          }
                        } catch (_) {}
                                                    ...
                                                    new Column(
                                                      ...
                                                      height: 8.0,
                                                        ...
                                                        new Row(
                                                          ...
                                                          children: <Widget>[
                                                            ((menuIdsMap[52]==true&&cifList[position].mmoduletype==30 )
                                                            ||(menuIdsMap[64]==true&&cifList[position].mmoduletype==11 )
                                                            ||(menuIdsMap[65]==true&&cifList[position].mmoduletype==20 )
                                                            )
                                                            ...
                                                            ,
                                                            new Text(" "),
                                                            cifList[position].mmoduletype == 11&&menuIdsMap[53]==true
                                                                ?   new Row(
                                                              textBaseline: TextBaseline.alphabetic,
                                                              children: <Widget>[
                                                                /*new Text("    "),*/
                                                            ...
                                                            ): cifList[position].mmoduletype == 30&& menuIdsMap[54]==true
                                                                ?  new Row(
                                                              textBaseline: TextBaseline.alphabetic,
                                                              children: <Widget>[
                                                                new RaisedButton(
                                                        ...
                                                        new Row(
                                                          textBaseline: TextBaseline.alphabetic,
                                                          children: <Widget>[
                                                            (cifList[position].mmoduletype == 11&& menuIdsMap[56]==true ) ?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                            ...
                                                            ) : (cifList[position].mmoduletype == 30 && cifList[position].macctstat !=  3&& menuIdsMap[57]==true )?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                            ...
                                                            new Text(" "),
                                                            (cifList[position].mmoduletype == 11 && cifList[position].macctstat !=  3 && menuIdsMap[58]==true)?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                            ...
                                                            ) : (cifList[position].mmoduletype == 30 && cifList[position].macctstat !=  3 && menuIdsMap[59]==true  )?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                              child: Text(Translations.of(context).text('Closure')),
                                                              textColor: Colors.white,
                                                            ...
                                                            ): (cifList[position].mmoduletype == 30 && cifList[position].macctstat ==  3 && menuIdsMap[60]==true) ?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                            ...
                                                            (isFullerTon==1 &&cifList[position].mmoduletype == 30&& cifList[position].macctstat != 3&&  cifList[position].mmainbal >=0.0 && menuIdsMap[61]==true) ?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                        ...
                                                        new Row(
                                                          textBaseline: TextBaseline.alphabetic,
                                                          children: <Widget>[
                                                            (cifList[position].mmoduletype == 11 && cifList[position].macctstat !=  3 && menuIdsMap[62]==true) ?
                                                            new RaisedButton(
                                                              color: Colors.teal,
                                                              child: Text(Translations.of(context).text('Closure')),
                                                              textColor: Colors.white,
                                                            ...
                                                            (cifList[position].mmoduletype == 30&& cifList[position].macctstat != 3 && menuIdsMap[63]==true) ?
                                                            new RaisedButton(
                                                              color: Colors.teal,
