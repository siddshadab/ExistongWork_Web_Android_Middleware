...
class LabelAction extends StatefulWidget {
  LabelAction({this.subItemList, Key key}) : super(key: key);
  final SubItem subItemList;

  @override
  _LabelActionState createState() => _LabelActionState(subItemList);
}

class _LabelActionState extends State<LabelAction> {
  _LabelActionState(this.subItemList);

  final SubItem subItemList;
  @override
  Widget build(BuildContext context) {
    return getScopedModel(null, subItemList, LabelCollisionFrontPanel(subItemList));
  }
}
...
class _LabelCollisionFrontPanelState extends State<LabelCollisionFrontPanel> {
  _LabelCollisionFrontPanelState(this.subItemList);
  final SubItem subItemList;
