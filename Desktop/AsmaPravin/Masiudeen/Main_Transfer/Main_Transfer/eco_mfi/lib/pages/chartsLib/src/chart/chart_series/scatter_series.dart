...
class ScatterSeries<T, D> extends XyDataSeries<T, D> {
  ...
  bool _isLineType = false;

  /// Creates a collection of segments for the points in the series.
  @override
  void createSegments() {
    _isLineType = markerSettings.shape == DataMarkerType.verticalLine ||
        markerSettings.shape == DataMarkerType.horizontalLine;
    int segmentIndex = 0;
  ...
  void customizeSegment(ChartSegment segment) {
    ...
    segment.strokeColor = _isLineType
        ? ((pointColorMapper != null &&
                segment._currentPoint.pointColorMapper != null)
            ? segment._currentPoint.pointColorMapper
            : segment.series._seriesColor)
        : segment.series.borderColor;
    segment.strokeWidth =
        _isLineType ? markerSettings.width / 4 : segment.series.borderWidth;
  }
