...
class DemoAnnotationWatermark extends StatefulWidget{
  /// Creates the chart with annotation sample.
  //const DemoAnnotationWatermark(Key key) : super(key: key);
...
class _AnnotationWatermarkState extends State<DemoAnnotationWatermark> {
  ...
  SfCartesianChart _getWatermarkAnnotationChart() {
    return SfCartesianChart(
        title: ChartTitle(
            text: 'UK social media reach, by platform'),
