...
class ViewShortTermLiabilityDetails extends StatefulWidget {
  static const String routeName = '/material/data-table';


  @override
  _ViewShortTermLiabilityDetailsState createState() =>
      _ViewShortTermLiabilityDetailsState();
}

class _ViewShortTermLiabilityDetailsState
    extends State<ViewShortTermLiabilityDetails> {
  ...
  void initState() {
    ...
    if (CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList ==
        null) {
      CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList = List();
    }

    print("2" + CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList
        .toString());
        ...
        i++) {
          ...
          if (int.parse(globals.dropDownCaptionValuesCodeKeysBusiness[2][i].mcode) ==
              CustomerFormationMasterTabsState.custListBean
                  .shortTermLiabilitiesList[l].mshrttrmliabilty) {
            print("matched");
  ...
  void getRow(){
    rows2 = new List.generate(
        CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList.length,
            (int a) => new DataRow(
            ...
            cells: [
              ...
              new DataCell(
                  new Text(CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList[a].mpresentamt.toString())),
              new DataCell(new Text(CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList[a].mnextmonthamount
                  .toString())),
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: new AppBar(
          ...
          title: new Text(
            Translations.of(context).text('Shrt_Trm_Lblty_Dtl'),
  ...
  void deleteSelected(){
    ...
    for( var items in selectedIndex){
      CustomerFormationMasterTabsState.custListBean.shortTermLiabilitiesList.removeAt(items);
    }
    selectedIndex.clear();
    setState(() {
      getRow();
