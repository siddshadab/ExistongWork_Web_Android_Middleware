...
import 'CollateralsREMMaster.dart';
...
class _CollateralREMlandandhouseState extends State<CollateralREMlandandhouse> {
  ...
  FullScreenDialogForSubDistrictSelection _mySubDistrictDialog =
      new FullScreenDialogForSubDistrictSelection(
          true); //TODO ujk added boolean for removing error
  ...
  showDropDown(LookupBeanData selectedObj, int no) {
    if (selectedObj.mcodedesc.isEmpty) {
      ...
      switch (no) {
        case 0:
          Title = blankBean;
          CollateralsREMMasterState.collateralREMlandandhouseBean.mtitle =
              blankBean.mcode;
          break;
        case 1:
          HouseBuiltType = blankBean;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.mhousebuilttype = blankBean.mcode;
          break;
        case 2:
          EnvDescription = blankBean;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.menvdescription = blankBean.mcode;
          break;
        case 3:
          DescOfProperty = blankBean;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.mdescofproperty = blankBean.mcode;
          break;
        case 4:
          SizeOfProperty = blankBean;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.msizeofproperty = blankBean.mcode;
          break;
      ...
      for (int k = 0;
          ...
          k++) {
        if (globals.dropDownCaptionValuesCollateralREMlandandhouse[no][k]
                .mcodedesc ==
            selectedObj.mcodedesc) {
          setValue(no,
              globals.dropDownCaptionValuesCollateralREMlandandhouse[no][k]);
          isBreak = true;
          break;
        }
        if (isBreak) {
    ...
    setState(() {
      ...
      switch (no) {
        ...
        case 1:
          ...
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.mhousebuilttype = value.mcode;
          break;
        case 2:
          EnvDescription = value;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.menvdescription = value.mcode;
          break;
        case 3:
          DescOfProperty = value;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.mdescofproperty = value.mcode;
          break;
        case 4:
          SizeOfProperty = value;
          CollateralsREMMasterState
              .collateralREMlandandhouseBean.msizeofproperty = value.mcode;
          break;
        default:
          break;
      }
  ...
  List<DropdownMenuItem<LookupBeanData>> generateDropDown(int no) {
    ...
    for (int k = 0;
        ...
        k++) {
      mapData
          .add(globals.dropDownCaptionValuesCollateralREMlandandhouse[no][k]);
    }
  ...
  void initState() {
    ...
    if (!registrationDate.contains("_")) {
      try {
        ...
        DateTime formattedDate = DateTime.parse(
            tempRegistrationDate.substring(6) +
                "-" +
                tempRegistrationDate.substring(3, 5) +
                "-" +
                tempRegistrationDate.substring(0, 2));
        //   print(formattedDate);
    ...
    if (!EPEBDate.contains("_")) {
      try {
        ...
        DateTime formattedDate = DateTime.parse(tempEPEBDate.substring(6) +
            "-" +
            tempEPEBDate.substring(3, 5) +
            "-" +
            tempEPEBDate.substring(0, 2));
        //   print(formattedDate);
    ...
    tempDropDownValues.add(CollateralsREMMasterState
    ...
    for (int k = 0;
      ...
      for (int i = 0;
          ...
          i++) {
        if (globals
                .dropDownCaptionValuesCollateralREMlandandhouse[k][i].mcode ==
            tempDropDownValues[k]) {
          setValue(
              k, globals.dropDownCaptionValuesCollateralREMlandandhouse[k][i]);
        }
      }
    }
  }
  ...
  Future<Null> getSessionVariables() async {
    ...
    if (CollateralsREMMasterState.collateralREMlandandhouseBean.mdist != null) {
      await AppDatabase.get()
          .getDistrictNameViaDistrictCode(CollateralsREMMasterState
    ...
    if (CollateralsREMMasterState.collateralREMlandandhouseBean.marea != null) {
      await AppDatabase.get()
          .getAreaNameViaAreaCode(CollateralsREMMasterState
              ...
              children: [
                ...
                Container(
                    ...
                    child: new TextFormField(
                      ...
                      initialValue: CollateralsREMMasterState
                          ...
                          ? CollateralsREMMasterState
                              .collateralREMlandandhouseBean.mfname
                          : "",
                      onSaved: (val) => CollateralsREMMasterState
                          .collateralREMlandandhouseBean.mfname = val,
                    )),
                Container(
                    color: Constant.semiMandatoryColor,
                    child: new TextFormField(
                      ...
                      initialValue: CollateralsREMMasterState
                          ...
                          : "",
                      onSaved: (val) => CollateralsREMMasterState
                          .collateralREMlandandhouseBean.mmname = val,
                    )),
                ...
                Container(
                    ...
                    child: new TextFormField(
                      ...
                      initialValue: CollateralsREMMasterState
                          ...
                          : "",
                      onSaved: (val) => CollateralsREMMasterState
                          .collateralREMlandandhouseBean.mlname = val,
                    )),
                Container(
                  ...
                  child: new Row(
                    children: <Widget>[
                      Text(
                        Translations.of(context).text('AddDet'),
                ...
                Container(
                  ...
                  child: new TextFormField(
                    ...
                    inputFormatters: [
                      new LengthLimitingTextInputFormatter(149),
                      globals.onlyAphaNumeric
                    ],
                    controller: CollateralsREMMasterState
                        ...
                        : TextEditingController(
                            text: CollateralsREMMasterState
                                .collateralREMlandandhouseBean.maddress1),
                    onSaved: (val) {
                      if (val != null && val != "") {
                        try {
                          CollateralsREMMasterState
                              .collateralREMlandandhouseBean.maddress1 = (val);
                        } catch (e) {}
                      }
                    },
                  ),
                  ...
                  child: new TextFormField(
                    ...
                    onSaved: (val) {
                      if (val != null && val != "") {
                        try {
                          CollateralsREMMasterState
                              .collateralREMlandandhouseBean.maddress2 = (val);
                        } catch (e) {}
                      }
                    },
                  ),
                ...
                Container(
                  ...
                  child: new ListTile(
                    ...
                    subtitle: countryName == null || countryName == "null"
                        ? new Text("")
                ...
                Container(
                  ...
                  child: new ListTile(
                    ...
                    subtitle: stateName == null || stateName == "null"
                        ? new Text("")
                        : new Text("${stateName} "),
                    onTap: () async {
                      getStateName();
                ...
                Container(
                  ...
                  child: new ListTile(
                    ...
                    subtitle: districtName == null || districtName == "null"
                        ? new Text("")
                ...
                Container(
                  ...
                  child: new ListTile(
                    ...
                    subtitle:
                        subDistrictName == null || subDistrictName == "null"
                            ? new Text("")
                ...
                new ListTile(
                  ...
                  subtitle: areaName == null || areaName == "null"
                      ? new Text("")
                      : new Text("${areaName}"),
                  onTap: () async {
                    getArea();
                ...
                Container(
                  ...
                  child: new Row(
                    children: <Widget>[
                      Text(
                        Translations.of(context).text('PropDet'),
                        style: TextStyle(color: Colors.blue, fontSize: 25.0),
                      )
                    ],
                  ),
...
*/
                Container(
                  ...
                  child: new DropdownButtonFormField(
                    ...
                    decoration: InputDecoration(
                        labelText: Translations.of(context).text('SzeOfrop')),
                  ),
                ),
                Container(
                  child: new TextFormField(
                ...
                Container(
                  child: new DropdownButtonFormField(
                    ...
                    decoration: InputDecoration(
                        labelText: Translations.of(context).text('DescProp')),
                  ),
                ),
                //    Container(
                /*   color: Constant.semiMandatoryColor,
  ...
  Future getCountryName() async {
    tempContrybean = await Navigator.push(
        context,
    ...
    if (tempContrybean != null) {
      CollateralsREMMasterState.collateralREMlandandhouseBean.mcountry =
          tempContrybean.cntryCd;
      AppDatabase.get()
          .getCountryNameViaCountryCode(tempContrybean.cntryCd.toString())
          .then((onValue) {
        countryName = onValue.countryName;
  ...
  Future getStateName() async {
    tempStateBean = await Navigator.push(
        context,
        new MaterialPageRoute(
    ...
    if (tempStateBean != null) {
      CollateralsREMMasterState.collateralREMlandandhouseBean.mstate =
          tempStateBean.stateCd;
      AppDatabase.get()
          .getStateNameViaStateCode(tempStateBean.stateCd.toString())
          .then((onValue) {
        stateName = onValue.stateDesc;
      });
    }
  ...
  Future getDistrictName() async {
    tempDistrictBean = await Navigator.push(
        context,
        new MaterialPageRoute(
    ...
    if (tempDistrictBean != null) {
      CollateralsREMMasterState.collateralREMlandandhouseBean.mdist =
          tempDistrictBean.distCd.toString();
      AppDatabase.get()
          .getDistrictNameViaDistrictCode(tempDistrictBean.distCd.toString())
          .then((onValue) {
        districtName = onValue.distDesc;
      });
    }
  ...
  Future getSubDistrictName() async {
    tempSubDistrictBean = await Navigator.push(
        context,
        new MaterialPageRoute(
    ...
    if (tempSubDistrictBean != null) {
      CollateralsREMMasterState.collateralREMlandandhouseBean.msubdist =
          tempSubDistrictBean.placeCd;
      AppDatabase.get()
          .getPlaceNameViaPlaceCode(tempSubDistrictBean.placeCd.toString())
          .then((onValue) {
        subDistrictName = onValue.placeCdDesc;
      });
    }
  ...
  Future getArea() async {
    tempAreaDistrict = await Navigator.push(
        context,
        new MaterialPageRoute(
    ...
    if (tempAreaDistrict != null) {
      CollateralsREMMasterState.collateralREMlandandhouseBean.marea =
          tempAreaDistrict.areaCd.toString();
      AppDatabase.get()
          .getAreaNameViaAreaCode(tempAreaDistrict.areaCd.toString())
          .then((onValue) {
        areaName = onValue.areaDesc;
      });
    }
  ...
  Future<Null> _selectDate(BuildContext context) async {
    ...
    if (picked != null &&
        picked !=
            CollateralsREMMasterState.collateralREMlandandhouseBean.mregdate)
      setState(() {
        CollateralsREMMasterState.collateralREMlandandhouseBean.mregdate =
            picked;
  ...
  Future<Null> _selectDateE(BuildContext context) async {
    ...
    if (picked != null &&
        picked !=
            CollateralsREMMasterState.collateralREMlandandhouseBean.mepebdate)
      setState(() {
        CollateralsREMMasterState.collateralREMlandandhouseBean.mepebdate =
            picked;
