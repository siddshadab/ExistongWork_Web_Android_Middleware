...
class _CollateralVehicleValuation3State
    ...
    if (selectedObj.mcodedesc.isEmpty) {
      ...
      switch (no) {
        case 0:
          ...
          CollateralVehicleMasterState.collateralVehicleBean.mbcbacklightr =
              blankBean.mcode;
          break;
        case 1:
          BcTurnSignal = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcturnsignal =
              blankBean.mcode;
          break;
        case 2:
          BcMessageSignal = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcmessagesignal =
              blankBean.mcode;
          break;
        case 3:
          BcSignal = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcsignal =
              blankBean.mcode;
          break;
        case 4:
          BcBackLightL = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcbacklightl =
              blankBean.mcode;
          break;
        case 5:
          BcBackDoor = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcbackdoor =
              blankBean.mcode;
          break;
        case 6:
          BcCranes = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbccranes =
              blankBean.mcode;
          break;
        case 7:
          BcTaKeLock = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbctakelock =
              blankBean.mcode;
          break;
        case 8:
          BcHoldLock = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcholdlock =
              blankBean.mcode;
          break;
        case 9:
          BcHandCranes = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbchandcranes =
              blankBean.mcode;
          break;
        case 10:
          BcReserveTire = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcreservetire =
              blankBean.mcode;
          break;
        case 11:
          BcBackMirror = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcbackmirror =
              blankBean.mcode;
          break;
        case 12:
          BcAntenna = blankBean;
          CollateralVehicleMasterState.collateralVehicleBean.mbcantenna =
              blankBean.mcode;
          break;
        default:
          break;
      ...
      for (int k = 0;
          k <
              globals
                  .dropdownCaptionsValuesCollateralVehicleValuation3[no].length;
          k++) {
        if (globals.dropdownCaptionsValuesCollateralVehicleValuation3[no][k]
                .mcodedesc ==
            selectedObj.mcodedesc) {
          setValue(no,
              globals.dropdownCaptionsValuesCollateralVehicleValuation3[no][k]);
          isBreak = true;
          break;
        }
        if (isBreak) {
  ...
  void initState() {
    ...
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbcbackdoor);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbccranes);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbctakelock);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbcholdlock);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbchandcranes);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbcreservetire);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbcbackmirror);
    tempDropDownValues
        .add(CollateralVehicleMasterState.collateralVehicleBean.mbcantenna);
    ...
    for (int k = 0;
      ...
      for (int i = 0;
          i <
              globals
                  .dropdownCaptionsValuesCollateralVehicleValuation3[k].length;
          i++) {
        try {
          if (globals
                  .dropdownCaptionsValuesCollateralVehicleValuation3[k][i].mcode
                  .toString()
                  .trim() ==
            ...
            setValue(
                k,
                globals.dropdownCaptionsValuesCollateralVehicleValuation3[k]
                    [i]);
          }
        } catch (_) {
          ...
          Container(
            child: new DropdownButtonFormField(
              ...
              decoration: InputDecoration(
                  labelText: Translations.of(context).text('BckLghtrghtsde')),
            ),
          ),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('TrnSgnl')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('MsgSgnl')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('Sgnl')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('BckLghtLftsde')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('BckDr')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('cranes')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('TaKeLck')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('HldLck')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('HndCrns')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('RsrveTre')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('bckmir')),
          )),
          Container(
              child: new DropdownButtonFormField(
            ...
            decoration: InputDecoration(
                labelText: Translations.of(context).text('antenna')),
          )),
        ],
      ),
    );
