...
import 'package:eco_mfi/pages/workflow/address/beans/GetCountrySelectionList.dart';
            ...
            Expanded(
              child:  new Card(
                  child:new ListTile(
                    ...
                    title:new Text(items[index].countryName,
    ...
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text(
          ...
          Translations.of(context).text('Country_List'),
