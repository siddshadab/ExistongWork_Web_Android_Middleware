...
class _PyramidSeriesBase<T, D> extends ChartSeries<T, D>
  ...
  void calculateEmptyPointValue(
      int pointIndex, PointInfo<dynamic> currentPoint) {
    final EmptyPointSettings empty = emptyPointSettings;
    final int pointLength = _dataPoints.length;
    final PointInfo<dynamic> point = _dataPoints[pointIndex];
    if (point.y == null) {
      switch (empty.mode) {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int pointIndex = 0;
      ...
      if (series._renderPoints[pointIndex].isVisible) {
        ...
        chart._chartSeries._calculatePyramidSegments(canvas, pointIndex);
      }
    }
  }
...
abstract class _PyramidChartSegment {
  Color getPointColor(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, Color color, double opacity);

  double getPointOuterRadius(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, double outerRadius);

  double getPointInnerRadius(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, double innerRadius);

  bool getPointExplode(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, bool isExplode);

  double getOpacity(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, double opacity);

  Color getPointStrokeColor(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, Color strokeColor);

  double getPointStrokeWidth(PyramidSeries<dynamic, dynamic> series,
      PointInfo<dynamic> point, int pointIndex, double strokeWidth);
}
