...
class GetDisbursedListFromMiddleware{
  String timestamp() => DateTime.now().millisecondsSinceEpoch.toString();
  static Utility obj = new Utility();
  static final _headers = {'Content-Type': 'application/json'};
  var urlGetDisbursmentListDetails =
      "DisbursedListController/getDisbursedListbyCreatedByAndLastSyncedTiming/";
  ...
  Future<Null> getMiddleWareData(
    ...
    await AppDatabase.get()
        .selectStaticTablesLastSyncedMaster(26,true)
        .then((onValue) async {
    ...
    //try {
      ...
      if (bodyValue == "404" ) {
        ...
        for (int dsbrs = 0; dsbrs< obj.length; dsbrs++) {
          print("for i = ${dsbrs} val is ${obj[dsbrs].disbursedBean}");
          await AppDatabase.get()
              .updateDisbursedMaster(obj[dsbrs])
              .then((onValue) {
        ...
        AppDatabase.get().updateStaticTablesLastSyncedMasterGetFromServer(26,updateDateimeAfterUpdate);
