...
class DefaultZooming extends StatefulWidget {
  DefaultZooming({this.sample, Key key}) : super(key: key);
  SubItem sample;
...
class _DefaultZoomingState extends State<DefaultZooming> {
  ...
  Widget build(BuildContext context) {
    return getScopedModel(null, sample, SelectionZoomingFrontPanel(sample));
  }
}

ZoomPanBehavior zoomingPanBehavior;
...
List<ScatterSeries<ChartSampleData, num>> getZoomScatterSeries(
    bool isTileView) {
...
final List<ChartSampleData> zoomData1 = <ChartSampleData>[
