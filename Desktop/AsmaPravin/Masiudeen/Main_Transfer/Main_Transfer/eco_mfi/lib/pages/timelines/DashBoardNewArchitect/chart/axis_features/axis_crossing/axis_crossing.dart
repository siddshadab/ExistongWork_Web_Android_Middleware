...
class AxisCrossing extends StatefulWidget {
  AxisCrossing({this.subItemList, Key key}) : super(key: key);
  final SubItem subItemList;
  @override
  _AxisCrossingState createState() => _AxisCrossingState(subItemList);
}

class _AxisCrossingState extends State<AxisCrossing> {
  _AxisCrossingState(this.subItemList);
  final SubItem subItemList;
  @override
  Widget build(BuildContext context) {
    return getScopedModel(null, subItemList, AxisCrossingFrontPanel(subItemList));
  }
}
...
class _AxisCrossingFrontPanelState extends State<AxisCrossingFrontPanel> {
  _AxisCrossingFrontPanelState(this.subItemList);
  final SubItem subItemList;
