...
class _PlotBandPainter extends CustomPainter {
  ...
  void _renderPlotBandElement(ChartAxis axis, num startValue, num endValue,
    ...
    startValue = startValue == null
        ? axis._visibleRange.minimum
        : startValue = startValue;

    endValue =
        endValue == null ? axis._visibleRange.maximum : endValue = endValue;
    ...
    _drawPlotBand(plotBand, plotBandRect, textAngle, canvas);
  }

  void _drawPlotBand(
      PlotBand plotBand, Rect plotBandRect, int textAngle, Canvas canvas) {
