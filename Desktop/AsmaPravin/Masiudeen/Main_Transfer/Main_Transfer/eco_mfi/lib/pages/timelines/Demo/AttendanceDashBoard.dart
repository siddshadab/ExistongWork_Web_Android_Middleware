import 'package:eco_mfi/pages/timelines/Demo/constants/dashboard_tile_info.dart';
import 'package:eco_mfi/pages/timelines/Demo/dashboard_tile.dart';
...
class AttendanceDashBoard extends StatefulWidget {
  @override
  _AttendanceDashBoardState createState() => new _AttendanceDashBoardState();
}
...
class _NavigationPanelState extends State<NavigationPanel> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        color: globals.appbar ?? Color(0xff07426A),
        child: ListView(
          children: <Widget>[
//            FutureBuilder(
...
//            ),
            ...
            drawerTile("Check IN/ Check Out", () {}, Icons.exit_to_app),
