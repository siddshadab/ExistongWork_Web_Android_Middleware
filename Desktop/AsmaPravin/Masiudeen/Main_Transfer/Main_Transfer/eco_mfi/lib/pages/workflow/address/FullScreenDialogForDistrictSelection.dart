...
import 'package:eco_mfi/pages/workflow/address/beans/GetDistrictSelectionList.dart';
            ...
            Expanded(
              child:  new Card(
                  child:new ListTile(
                    ...
                    title: new Text(items[index].distDesc,
              style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text(
          Translations.of(context).text('District_List'),
