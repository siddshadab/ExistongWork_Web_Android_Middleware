...
//  var permissions =  Permission.getPermissionsStatus([PermissionName.Storage]);

 // var permissionNames =  Permission.requestPermissions([PermissionName.Storage, PermissionName.Camera]);
