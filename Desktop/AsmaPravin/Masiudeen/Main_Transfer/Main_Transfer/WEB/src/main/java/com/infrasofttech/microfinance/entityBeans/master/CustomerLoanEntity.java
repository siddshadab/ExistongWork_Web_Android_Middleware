...
@Index(name = "mclustered_hidx",columnList= "mleadsid,mcreatedby,mcusttrefno,mcustmrefno,mlastupdatedt,mcreateddt,mlastsynsdate,mcustno,mprdacctid,missynctocoresys"),
})
@Data
