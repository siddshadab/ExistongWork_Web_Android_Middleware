...
@Entity
@Table(name = "cgt2master")
@Data
public class CGT2Entity extends BaseEntity {
	...
	@Column(name = "trefno",  nullable = false, columnDefinition = "numeric(8)")               
	 ...
	 @Column(name = "mcgt2doneby",  columnDefinition = "NVarChar(8)")
	 ...
	 @OneToMany(mappedBy = "checkListCgt2Entity", cascade = CascadeType.ALL,fetch=FetchType.EAGER)
     @Fetch(FetchMode.SELECT)
     @IndexColumn(name="INDEX_COL")
 	 /*@JsonIgnore
 	 @LazyCollection(LazyCollectionOption.FALSE)*/
 	 private Collection<CheckListCGT2Entity> checkListCgt2Details = new ArrayList<CheckListCGT2Entity>();
